...
const createCard = (item, i) => {
    ...
    if (i % 2 != 0) {
        ...
        imgFront.height = 17
        imgBack.src = './assets/logo/emoney.png'
        imgBack.height = 17
    } else {
        imgFront.src = './assets/logo/mandiri-white.png'
        imgFront.height = 17
        imgBack.src = './assets/logo/emoney-white.png'
        imgBack.height = 17
        front.id = "front"
        back.id = "back"
    }
    ...
    input.addEventListener('input', (e) => {
        ...
        if (e.target.checked) {
            ...
            setTimeout(() => createModal(currentGame.nominals[coupon.prize].prize, coupon), 2000);
            setTimeout(() => handlerSubmitWinner("Pemenang", coupon), 7000);
        }
    })
}
