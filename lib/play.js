...
let count_times = 0
const logos = ["./assets/logo/blue.png", "./assets/logo/white.png"];
...
const createCard = (item, i) => {
    ...
    let bgIndex = switch_random ? (i%2 == 0) ? 1 : 0 : (i%2 == 0) ? 0 : 1

    front.style.background = `url(${logos[bgIndex]}) no-repeat center center fixed`;
    front.style.backgroundSize = `106%`;
