...
const createCard = (item, i) => {
    ...
    let logo_id = Math.max(Math.floor(Math.random()*3), 0)
    ...
    if (logo_id == 1) imgFront.height = 25;
    else if (logo_id == 2) imgFront.height = 25;
    else imgFront.height = 16;
...
const shortNominal = (nominal = 0) => {
    ...
    if (_nom?.length === 4) {
        if (_nom[1] == "0") _nom = _nom?.substring(0, 1) + "Rb" 
        else _nom = _nom?.substring(0, 1) + "." + _nom[1] + "RB" 
        ...
        if (_nom[1] == "0") _nom = _nom?.substring(0, 1) + "Jt" 
        else _nom = _nom?.substring(0, 1) + "." + _nom[1] + "Jt"
    } 
